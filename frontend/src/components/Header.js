...
function Header() {
    return (
        <header class="w-full shadow-lg bg-white items-center h-16 rounded-2xl z-40 fixed">
            <div class="relative z-20  flex-col justify-center h-full px-3 mx-auto flex-center hidden md:flex">
                <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                    <div class="container relative left-0 z-50 flex w-3/4 h-full">
                        <div class="relative p-1 flex items-center justify-start w-1/2 ml-5 mr-4 sm:mr-0 sm:right-auto">
                            <a href="/" class="block relative text-lg font-semibold text-slate-600">
                                GadgetsVio &nbsp;&nbsp;
                            </a>
                        </div>
                        <div class="relative p-1 flex items-center justify-start w-1/2 ml-5 mr-4 sm:mr-0 sm:right-auto">
            ...
            <div class="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center  md:hidden">
                <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                    <div class="container relative left-0 z-50 flex w-3/4 h-full">
                        <div class="relative mt-7 flex items-center justify-start w-1/4  mr-5 sm:mr-0 sm:right-auto">
                            <a href="/" class="block relative text-lg font-semibold text-slate-600">
                                GadgetsVio &nbsp;&nbsp;
                            </a>
                        </div>
