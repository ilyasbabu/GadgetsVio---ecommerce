        ...
        <div>
            <div className='flex md:flex-row justify-between pb-6 flex-col'>
                ...
                <div className='flex flex-col justify-between'>
                    <p class="text-xs leading-3 text-gray-800  md:pt-0 pt-4">Added on 21-23-1222</p>
                    <div class="flex items-center justify-between w-full">
                        <p class="text-base font-black leading-none text-gray-800 ">Luxe card holder 4546GB 34</p>
                    ...
                    <div class="flex items-center justify-between pt-5">
                        <div class="flex justify-between w-full">
                            ...
                            <div>
                                <p class="md:hidden text-lg font-black leading-none text-gray-800 ">$ 1000</p>
                            </div>
                        </div>
                    </div>
                </div>
