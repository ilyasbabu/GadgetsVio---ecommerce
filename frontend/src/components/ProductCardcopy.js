...
function ProductCard2({ product }) {
  ...
  return (
    <div className='pt-5 px-7 pb-7 bg-white shadow-xl mx-4 mt-2 mb-7 dark:bg-gradient-to-tl dark:from-zinc-900  dark:to-black bg-gradient-to-tl from-blue-50 via-white to-white \
          dark:shadow-black dark:hover:shadow-zinc-800 hover:shadow-zinc-500 transition ease-in-out duration-500'>
      <div className='text-xs w-64 pt-1 pb-2 '>
