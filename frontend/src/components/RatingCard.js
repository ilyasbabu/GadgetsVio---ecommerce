    ...
    return (
        <div className='px-4'>
            ...
            <div className="flex items-center">
                ...
                <p className="ml-2 text-sm font-bold text-gray-900 dark:text-gray-400">3</p>
                <span className="w-1 h-1 mx-1.5 bg-gray-500 rounded-full"></span>
                <a href="#reviewsA" className="text-sm font-medium text-gray-900 underline hover:no-underline dark:text-gray-400">45 reviews</a>
            </div>
