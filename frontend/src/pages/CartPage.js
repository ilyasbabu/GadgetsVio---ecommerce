...
function CartPage() {
    ...
    return (
        <div>
            ...
            <div className='w-full h-full flex lg:flex-row flex-col justify-between'>
                <div className='h-full'>
                    <div className='lg:px-72 md:px-7 px-4 lg:py-20 md:py-10 py-6'>
                        <p class="lg:text-4xl text-3xl font-black leading-9 text-gray-800 dark:text-white">Cart</p>

                        {/* produc */}
                        <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                            <div class="md:w-4/12 2xl:w-1/4 w-full">
                                <img src="https://i.ibb.co/6gzWwSq/Rectangle-20-1.png" alt="Black Leather Purse" class="h-full object-center object-cover md:block w-1/2 sm:w-auto" />
                            </div>
                            <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                                ...
                                <div class="flex items-center justify-between pt-5">
                                    ...
                                    <p class="text-base font-black leading-none text-gray-800 dark:text-white">$ 1000</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                            <div class="md:w-4/12 2xl:w-1/4 w-full">
                                <img src="https://i.ibb.co/6gzWwSq/Rectangle-20-1.png" alt="Black Leather Purse" class="h-full object-center object-cover md:block " />
            ...
            {/* <div class="w-full h-full bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden " >
                <div class="w-full absolute  h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" >
                    <div class="flex items-end lg:flex-row flex-col justify-between" id="cart">
                        <div class="lg:w-1/2 md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 ml-40 bg-white dark:bg-gray-800 overflow-y-hidden overflow-x-hidden lg:h-screen h-auto" id="scroll">
