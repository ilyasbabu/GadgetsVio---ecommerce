...
function Header() {
    ...
    return (
        <header className="w-full shadow-lg dark:shadow-md dark:shadow-black bg-white dark:bg-black transition ease-in-out duration-300 items-center h-16 rounded-2xl z-40 fixed">
                ...
                <div className="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                    <div className="container relative left-0 z-50 flex w-3/4 h-full">
                        ...
                        <div className="relative p-1 flex items-center justify-start w-1/2 ml-5 mr-4 sm:mr-0 sm:right-auto">
                            ...
                            <input type="text" className="block w-full py-1.5 pl-10 pr-4 leading-normal rounded-2xl focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 ring-opacity-90 bg-gray-100 dark:bg-zinc-900 transition ease-in-out duration-300 text-gray-400 aa-input" placeholder="Search" />
                ...
                <div className="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                    <div className="container relative left-0 z-50 flex w-1/2 h-full">
                        <div className="relative mt-7 flex items-center justify-start w-1/4  mr-5 sm:mr-0 sm:right-auto">
                            <Link to="/" className="block relative text-lg font-semibold text-slate-600 dark:text-white transition ease-in-out duration-300">
                                GadgetsVio &nbsp;&nbsp;
                            </Link>
                        </div>
                    </div>
