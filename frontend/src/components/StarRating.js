...
function StarRating({ starCount, text }) {
    return (
        <ul className="flex items-center">
            <li>
                <i className={`w-full h-full text-yellow-300 hover:text-yellow-400 ${starCount >= 1 ? "fas fa-star" : starCount >= 0.5 ? "fas fa-star-half-alt" : "far fa-star"}`}></i>
            </li>
            <li>
            ...
            <li>
                <i className={`w-full h-full text-yellow-300 hover:text-yellow-400 ${starCount >= 5 ? "fas fa-star" : starCount >= 4.5 ? "fas fa-star-half-alt" : "far fa-star"}`}></i>
            </li>
